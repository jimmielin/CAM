...
!-------------------------------------------------------
      ...
      rate(:,504) = 1.2e-14_r8
      rate(:,505) = 2e-10_r8
      rate(:,516) = 1.34e-11_r8
      rate(:,522) = 1.34e-11_r8
      rate(:,526) = 1.7e-11_r8
      rate(:,546) = 2.31e-07_r8
      rate(:,547) = 2.31e-06_r8
      rate(:,548) = 4.63e-07_r8
      ...
      rate(:,504) = 1.2e-14_r8 * exp_fac(:)
      rate(:,505) = 2e-10_r8 * exp_fac(:)
      rate(:,516) = 1.34e-11_r8 * exp_fac(:)
      rate(:,522) = 1.34e-11_r8 * exp_fac(:)
      rate(:,526) = 1.7e-11_r8 * exp_fac(:)
      rate(:,546) = 2.31e-07_r8 * exp_fac(:)
      rate(:,547) = 2.31e-06_r8 * exp_fac(:)
      rate(:,548) = 4.63e-07_r8 * exp_fac(:)
      ...
      rate(:,524) = 7.5e-13_r8 * exp_fac(:)
      rate(:,527) = 7.5e-13_r8 * exp_fac(:)
      ...
      rate(:,515) = 2.6e-12_r8 * exp_fac(:)
      rate(:,525) = 2.6e-12_r8 * exp_fac(:)
      rate(:,528) = 2.6e-12_r8 * exp_fac(:)
      ...
      rate(:,509) = 3.03e-12_r8 * exp_fac(:)
      exp_fac(:) = exp( 410._r8 * itemp(:) )
      rate(:,386) = 2.54e-11_r8 * exp_fac(:)
      rate(:,513) = 2.54e-11_r8 * exp_fac(:)
      ...
      rate(:,502) = 2.75e-13_r8 * exp_fac(:)
      rate(:,510) = 2.12e-13_r8 * exp_fac(:)
      rate(:,518) = 2.6e-13_r8 * exp_fac(:)
