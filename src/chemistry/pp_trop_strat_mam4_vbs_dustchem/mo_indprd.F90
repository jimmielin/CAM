...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,479)*y(:,223)*y(:,126) +rxt(:,488)*y(:,127)

         prod(:,2) = (rxt(:,412)*y(:,205) +rxt(:,415)*y(:,216) +rxt(:,418)*y(:,218) + &
                 rxt(:,422)*y(:,147))*y(:,131) +.500_r8*rxt(:,351)*y(:,223)*y(:,115) &
                  +.200_r8*rxt(:,447)*y(:,221)*y(:,130) +.500_r8*rxt(:,459)*y(:,183) &
                 *y(:,132)
