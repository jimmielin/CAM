...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt    = 123, &    ! number of photolysis reactions
                            rxntot    = 548, &    ! number of total reactions
                            gascnt    = 425, &    ! number of gas phase reactions
                            nabscol   = 2, &      ! number of absorbing column densities
                            gas_pcnst = 235, &     ! number of "gas phase" species
                            nfs       = 3, &       ! number of "fixed" species
                            relcnt    = 0, &    ! number of relationship species
                            grpcnt    = 0, &    ! number of group members
                            nzcnt     = 2296, & ! number of non-zero matrix entries
                            ...
                            clscnt4   = 233, &   ! number of species in implicit class
