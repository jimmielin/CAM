...
! !USES:
  ...
  use shr_const_mod, only: SHR_CONST_RDAIR, SHR_CONST_MWDAIR, SHR_CONST_RGAS
...
! !PUBLIC MEMBER FUNCTIONS:
  public modal_aero_gasaerexch_run, modal_aero_gasaerexch_init

! !PUBLIC DATA MEMBERS:
  integer, protected, public :: maxspec_pcage
...
!----------------------------------------------------------------------
!BOP
! !ROUTINE:  modal_aero_gasaerexch_run --- ...
!
! !INTERFACE:
...
! local
   ...
   real(r8), parameter :: mwdry = SHR_CONST_MWDAIR
...
!     integer,  intent(in)  :: idiagss
      ...
      real(r8), parameter :: rgas = SHR_CONST_RGAS * 1.0e-3_r8  ! J/K/kmol -> J/K/mol
