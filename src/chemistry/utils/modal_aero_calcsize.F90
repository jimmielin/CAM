...
subroutine modal_aero_calcsize_diag(state, pbuf, aero_props, aero_state, dgnum_m, &
   ...
   do n = 1, nmodes
      ...
      call aero_state%ambient_num_ptr(n, mode_num)
      ...
      do l1 = 1, nspec
         ...
         call aero_state%ambient_mmr_ptr(species_ndx=l1, bin_ndx=n, mmr=specmmr)
...
subroutine modal_aero_calcdry(state, pbuf, aero_props, aero_state, dgnumdry_m, hygro_m, dryvol_m, dryrad_m, drymass_m, so4dryvol_m, naer_m)
   ...
   do m = 1, nmodes
      ...
      do l = 1, nspec
         ...
         call aero_state%ambient_mmr_ptr(species_ndx=l, bin_ndx=m, mmr=raer)
