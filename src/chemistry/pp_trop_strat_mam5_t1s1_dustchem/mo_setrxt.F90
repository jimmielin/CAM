...
!-------------------------------------------------------
      ...
      rate(:,527) = 1.7e-11_r8
      rate(:,547) = 2.31e-07_r8
      rate(:,548) = 2.31e-06_r8
      rate(:,549) = 4.63e-07_r8
      ...
      rate(:,527) = 1.7e-11_r8 * exp_fac(:)
      rate(:,547) = 2.31e-07_r8 * exp_fac(:)
      rate(:,548) = 2.31e-06_r8 * exp_fac(:)
      rate(:,549) = 4.63e-07_r8 * exp_fac(:)
