...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) = (rxt(:,413)*y(:,206) +rxt(:,416)*y(:,217) +rxt(:,419)*y(:,219) + &
                 rxt(:,423)*y(:,147))*y(:,130) +.500_r8*rxt(:,352)*y(:,224)*y(:,114) &
                  +.200_r8*rxt(:,448)*y(:,222)*y(:,129) +.500_r8*rxt(:,460)*y(:,184) &
                 *y(:,131)
         prod(:,2) =rxt(:,480)*y(:,224)*y(:,125) +rxt(:,488)*y(:,126)
!--------------------------------------------------------------------
